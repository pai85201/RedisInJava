...
public class RangeProcessor extends AbstractCommandProcessor<ListManager> {
    ...
    public RangeProcessor(){
        super(ListManager.CommandCollection.RANGE.getCommandName(),
                ListManager.CommandCollection.RANGE.getMaxArgsCount(), ListManager.CommandCollection.RANGE.getMinArgsCount());
    }
